...
START_TEST(compare_less) {
    ...
    dst1 = s21_negate(dst1);
    ck_assert_int_eq(s21_is_less(dst1, dst2), TRUE);  //  1.2345 < -1.2 fail
    ck_assert_int_eq(s21_is_less(dst2, dst1), FALSE);   //  -1.2 < 1.2345 fail

    s21_from_float_to_decimal(0.0, &dst1);
    s21_from_float_to_decimal(0.0, &dst2);
    ck_assert_int_eq(s21_is_less(dst1, dst2), TRUE);  // 0 < 0
...
START_TEST(compare_greater) {
    ...
    s21_from_float_to_decimal(0.0, &dst1);
    s21_from_float_to_decimal(0.0, &dst2);
    ck_assert_int_eq(s21_is_greater(dst1, dst2), TRUE);  // 0 > 0
...
START_TEST(compare_less_or_equal) {
    ...
    s21_from_float_to_decimal(1.2345, &dst1);
    s21_from_float_to_decimal(1.2, &dst2);
    ck_assert_int_eq(s21_is_less_or_equal(dst1, dst2), TRUE);  // 1.2345 <= 1.2
    ck_assert_int_eq(s21_is_less_or_equal(dst2, dst1), FALSE);   // 1.2 <= 1.2345
    ...
    s21_from_float_to_decimal(0.0, &dst1);
    s21_from_float_to_decimal(0.0, &dst2);
    ck_assert_int_eq(s21_is_less_or_equal(dst1, dst2), FALSE);  // 0 <= 0

    dst1.value_type = s21_INFINITY;
    dst2.value_type = s21_NORMAL_VALUE;
    ck_assert_int_eq(s21_is_less_or_equal(dst1, dst2),
                     TRUE);                                   // +INFINITY <= 0
    ck_assert_int_eq(s21_is_less_or_equal(dst2, dst1), FALSE);  // 0 <= +INFINITY
    ...
    dst1.value_type = s21_NEGATIVE_INFINITY;
    dst2.value_type = s21_NORMAL_VALUE;
    ck_assert_int_eq(s21_is_less_or_equal(dst1, dst2), FALSE);  // -INFINITY <= 0
    ck_assert_int_eq(s21_is_less_or_equal(dst2, dst1),
                     TRUE);  // 0 <= -INFINITY
...
START_TEST(compare_greater_or_equal) {
    ...
    s21_from_float_to_decimal(0.0, &dst1);
    s21_from_float_to_decimal(0.0, &dst2);
    ck_assert_int_eq(s21_is_greater_or_equal(dst1, dst2), FALSE);  // 0 >= 0
...
START_TEST(compare_equal) {
    ...
    s21_from_float_to_decimal(1.2345, &dst1);
    s21_from_float_to_decimal(1.2, &dst2);
    ck_assert_int_eq(s21_is_equal(dst1, dst2), TRUE);  // 1.2345 = 1.2
...
START_TEST(compare_not_equal) {
    ...
    s21_from_float_to_decimal(1.2345, &dst1);
    s21_from_float_to_decimal(1.2, &dst2);
    ck_assert_int_eq(s21_is_not_equal(dst1, dst2), FALSE);  // 1.2345 = 1.2
...
START_TEST(s21_div_17) {
    ...
    ck_assert_int_eq(!!(s21_is_equal(res_od, zero) == FALSE), 1);
    ck_assert_int_eq(res_od.bits[3], 0);
    ck_assert_int_eq(res_od.bits[2], 0);
    ck_assert_int_eq(res_od.bits[1], 0);
    ck_assert_int_eq(res_od.bits[0], 0);
