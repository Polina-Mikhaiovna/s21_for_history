...
#define __CMP(V1, V2, L, LoEQ, EQ, GoEQ, G, NEQ) \
  ck_assert_int_eq(L,    s21_(is_less)            (DEC(V1), DEC(V2))); \
  ck_assert_int_eq(LoEQ, s21_(is_less_or_equal)   (DEC(V1), DEC(V2))); \
  ck_assert_int_eq(EQ,   s21_(is_equal)           (DEC(V1), DEC(V2))); \
  ck_assert_int_eq(GoEQ, s21_(is_greater_or_equal)(DEC(V1), DEC(V2))); \
  ck_assert_int_eq(G,    s21_(is_greater)         (DEC(V1), DEC(V2))); \
  ck_assert_int_eq(NEQ,  s21_(is_not_equal)       (DEC(V1), DEC(V2)));
...
#define __ROUNDING_TEST(V, ETRN, RETTRN, ERND, RETRND, EFLR, RETFLR) \
  ...
  ck_assert_int_eq(RETTRN, s21_(truncate)(DEC(V), &resultTrn)); \
  ck_assert_int_eq(RETRND, s21_(round)(DEC(V), &resultRnd)); \
  ck_assert_int_eq(RETFLR, s21_(floor)(DEC(V), &resultFlr)); \
  char str[6][32]; \
...
#define __DEC_AND_INT(V, I_E, R, D_E) \
  ...
  int new_int = 404., ret; \
  ret = s21_(from_decimal_to_int)(value, &new_int); \
  s21_(from_int_to_decimal)(new_int, &value); \
...
#define __FLOAT_TO_DEC(V, D_E, R) \
  ...
  int ret = s21_(from_float_to_decimal)(value, &result); \
...
#test NULL_ADD
  s21_(add)((s21_decimal){{1}}, (s21_decimal){{1}}, NULL);
// #test NULL_SUB
//   s21_(sub)((s21_decimal){{1}}, (s21_decimal){{1}}, NULL);
#test NULL_MUL
  s21_(mul)((s21_decimal){{1}}, (s21_decimal){{1}}, NULL);
// #test NULL_DIV
//   s21_(div)((s21_decimal){{1}}, (s21_decimal){{1}}, NULL);
#test NULL_MOD
  s21_(mod)((s21_decimal) {{1}}, (s21_decimal) {{1}}, NULL);

// #test NULL_ROUND
//   s21_(round)((s21_decimal){{1}}, NULL);
#test NULL_TRUNCATE
  s21_(truncate)((s21_decimal){{1}}, NULL);
// #test NULL_FLOOR
//   s21_(floor)((s21_decimal){{1}}, NULL);
#test NULL_NEGATE
  s21_(negate)((s21_decimal){{1}}, NULL);

#test NULL_INT2DEC
  s21_(from_int_to_decimal)(1, NULL);
// #test NULL_DEC2INT
// s21_(from_decimal_to_int)((s21_decimal) {{1}}, NULL);
#test NULL_FLOAT2DEC
  s21_(from_float_to_decimal)(1, NULL);
...
// #define __MUL_MNTSA(V1, V2, E, R) \
//   s21_decimal value_1, value_2, expectResult, expectMod, result, mod;\
//   value_1 = DEC(V1);\
//   value_2 = DEC(V2);\
//   expectResult = DEC(E);\
//   expectMod = DEC(R);\
//   mod = S21_mul_mntsa(value_1, value_2, &result);\
//   char strR[32];\
//   char strM[32];\
//   char strER[32];\
//   char strEM[32];\
...
#test FLOAT_TO_DEC_MAX_ZERO_DOT_1
  __FLOAT_TO_DEC(0.00000000000000000000000000000000000001, // V,
                 ".00000000000000000000000000000000000000 99999 99350 45640 39245 74614 153", 0) // D_E, R
...
#test FLOAT_TO_DEC_F_EXP_2_MINUS_126_VAL
  __FLOAT_TO_DEC(0.000000000000000000000000000000000000011754943508222875079687365372222456778186655567720875215087517062784172594547271728515625, // V,
                "0.00000 00000 00000 00000 00000 00000 00000 00 11754943508222875079687365372", 0) // D_E, R
...
// #test DIV_WTF1
// __arithmetic(s21_div,                        // FUNCNAME
//   " 20000 00000 00000 00000 00000 07.5", ".5",       // V1, V2  
//   "20000 00000 00000 00000 00000 00.1", 0); // E, R, 0234375
